...
namespace WarehouseManager.Data.Migrations
{
    ...
    [Migration("20220415020249_FixInventoryForeignKey")]
    partial class FixInventoryForeignKey
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WarehouseManager.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WarehouseManager.Models.Location", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WarehouseManager.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WarehouseManager.Models.Order", b =>
                {
                    ...
                    b.HasOne("WarehouseManager.Models.Supplier", "Supplier")
                        .WithMany()
